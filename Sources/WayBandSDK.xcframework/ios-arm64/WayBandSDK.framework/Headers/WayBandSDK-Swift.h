...
#ifndef WAYBANDSDK_SWIFT_H
#define WAYBANDSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WayBandSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC10WayBandSDK16BluetoothManager")
@interface BluetoothManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)stopScanningForDevices;
- (void)stopScanningAfterPairing;
- (void)stopScanningPairingError;
@end
...
@interface BluetoothManager (SWIFT_EXTENSION(WayBandSDK)) <CBPeripheralDelegate>
...
@interface BluetoothManager (SWIFT_EXTENSION(WayBandSDK)) <CBCentralManagerDelegate>
...
@interface BluetoothManager (SWIFT_EXTENSION(WayBandSDK))
- (void)peripheral:(CBPeripheral * _Nonnull)peripheral didUpdateValueForCharacteristic:(CBCharacteristic * _Nonnull)characteristic error:(NSError * _Nullable)error;
@end


SWIFT_CLASS("_TtC10WayBandSDK19BluetoothPeripheral")
...
@interface BluetoothPeripheral (SWIFT_EXTENSION(WayBandSDK)) <CBPeripheralDelegate>
...
SWIFT_CLASS("_TtC10WayBandSDK11DFUFirmware")
...
/// Uploading state.
SWIFT_PROTOCOL("_TtP10WayBandSDK19DFUProgressDelegate_")
...
/// The Logger delegate.
SWIFT_PROTOCOL("_TtP10WayBandSDK14LoggerDelegate_")
...
SWIFT_PROTOCOL("_TtP10WayBandSDK18DFUServiceDelegate_")
...
SWIFT_CLASS("_TtC10WayBandSDK16DFUFirmwareClass")
@interface DFUFirmwareClass : NSObject <CBCentralManagerDelegate, DFUProgressDelegate, DFUServiceDelegate, LoggerDelegate>
- (void)centralManagerDidUpdateState:(CBCentralManager * _Nonnull)central;
- (void)centralManager:(CBCentralManager * _Nonnull)central didDiscoverPeripheral:(CBPeripheral * _Nonnull)peripheral advertisementData:(NSDictionary<NSString *, id> * _Nonnull)advertisementData RSSI:(NSNumber * _Nonnull)RSSI;
- (void)dfuStateDidChangeTo:(enum DFUState)state;
- (void)dfuError:(enum DFUError)error didOccurWithMessage:(NSString * _Nonnull)message;
...
SWIFT_CLASS("_TtC10WayBandSDK15DFUFirmwareSize")
...
SWIFT_PROTOCOL("_TtP10WayBandSDK29DFUPeripheralSelectorDelegate_")
...
SWIFT_CLASS("_TtC10WayBandSDK21DFUPeripheralSelector")
...
SWIFT_CLASS("_TtC10WayBandSDK20DFUServiceController")
...
SWIFT_CLASS("_TtC10WayBandSDK19DFUServiceInitiator")
...
/// DFU UUID object.
SWIFT_CLASS("_TtC10WayBandSDK7DFUUuid")
...
/// the Nordic devices.
SWIFT_CLASS("_TtC10WayBandSDK13DFUUuidHelper")
...
/// be ignored.
SWIFT_CLASS("_TtC10WayBandSDK21IntelHex2BinConverter")
...
SWIFT_CLASS("_TtC10WayBandSDK25LegacyDFUServiceInitiator")
...
SWIFT_CLASS("_TtC10WayBandSDK25SecureDFUServiceInitiator")
...
SWIFT_CLASS("_TtC10WayBandSDK16VibrationManager")
...
SWIFT_CLASS("_TtC10WayBandSDK18WaybandBleServices")
@interface WaybandBleServices : UIView
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
@interface WaybandBleServices (SWIFT_EXTENSION(WayBandSDK)) <CBPeripheralDelegate>
- (void)peripheral:(CBPeripheral * _Nonnull)peripheral didDiscoverServices:(NSError * _Nullable)error;
- (void)peripheral:(CBPeripheral * _Nonnull)peripheral didDiscoverCharacteristicsForService:(CBService * _Nonnull)service error:(NSError * _Nullable)error;
- (void)peripheral:(CBPeripheral * _Nonnull)peripheral didUpdateValueForCharacteristic:(CBCharacteristic * _Nonnull)characteristic error:(NSError * _Nullable)error;
@end
